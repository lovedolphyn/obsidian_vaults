...
This note is designed to be dragged out and placed in one of the side panels. This allows you to have your DM Screen open but doesn't take you away from the core notes you are using to run your session.

Copy this code into a note and then drag that note into a side bar.

![Obsidian_XC6M4fICXG.gif](https://publish-01.obsidian.md/access/36b98e212e9d73fe1bd4813f96b0fd71/z_Assets/Obsidian_XC6M4fICXG.gif)
